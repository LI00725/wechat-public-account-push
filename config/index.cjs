...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5c8ca2ac77e940dc',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a9bc0254f3034d8e17485e7d18a1b9d1',
  ...
  USERS: [
    {
      ...
      id: 'oWP9X6-fKfMXLb73GoVrYSgveTss',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'MGzBjQCCnSa8ToGVfqMtGTF2zbUeA_qXCvNAHgYBfjI',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '成都',
      ...
      festivals: [
        ...
        {
          type: '四级', name: '李', year: '2022', date: '12-15',
        },
        {
          type: '计算机二级', name: '李', year: '2022', date: '12-5',
        },
